...
import getUsersAction from "@/proxy/user/get-user-using-username-action"; // New proxy function to fetch users
...
const SearchUserComponent = ({
  ...
  useEffect(() => {
    const performSearch = async () => {
      ...
      const userList: UserDataDto[] = await getUsersAction(searchTerm);
                    ...
                    <div className="flex items-center">
                      <div className="shrink-0">
                        <Image
                          ...
                          src={result.profilePictureUrl || userIcon}
                          alt="user image"
                        />
                      </div>
                      ...
                      <div className="inline-flex items-center text-base font-semibold text-gray-900">
                        <Button
                          ...
                          onClick={() => handleAddUser(result.username)}
                        >
                          +
                        </Button>
                      </div>
