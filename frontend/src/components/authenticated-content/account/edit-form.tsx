...
export default function EditForm({
  ...
  const checkXLink = () => {
    if (!xLinkRef.current.value.startsWith("https://x.com/")) {
      ...
      <div className="grid grid-cols-1 gap-10">
        ...
        <div className="max-w-96 w-full grid grid-cols-1 gap-10">
          ...
          <TextField
            ...
            name="visibleName"
            defaultValue={
              userData.visibleName !== "null" ? userData.visibleName : ""
            }
          />
          ...
          <motion.div className="grid gap-3 mt-5">
            ...
            <Input
              ...
              id="cvFile"
              type="file"
              className={"cursor-pointer " + (cvFile ? "hidden" : "")}
        ...
        <div className="grid gap-3 mt-5">
          <span className="block text-lg text-custom-gray">الجنس</span>
          <Radio
            name={"gender"}
            options={["ذكر", "انثى"]}
            values={["MALE", "FEMALE"]}
